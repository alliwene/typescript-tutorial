    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    testCollection = db.collection(process.env.COLLECTION_NAME);
                    exports.collections.tests = testCollection;
                    console.log("Successfully connected to database: ".concat(db.databaseName, " and collection: ").concat(testCollection.collectionName));
                    return [2 /*return*/];
            }
        });
    });
